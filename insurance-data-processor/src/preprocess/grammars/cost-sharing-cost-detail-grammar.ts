...
const grammar: Grammar = {
    ...
    ParserRules: [
        ...
        {
            name: 'expression$ebnf$1$subexpression$1$subexpression$1',
            symbols: [{ literal: ' ' }, /[cC]/, /[oO]/, /[pP]/, /[aA]/, /[yY]/],
            postprocess: function (d) {
                return d.join('');
            },
        },
        ...
        {
            name: 'expression',
            symbols: ['dollar', 'expression$ebnf$1', 'expression$ebnf$2', 'expression$ebnf$3'],
            postprocess: (match) => {
                return {
                    amount: match[0],
                    isPercent: false,
        ...
        {
            name: 'expression$ebnf$4$subexpression$1$subexpression$1',
            symbols: [{ literal: ' ' }, /[cC]/, /[oO]/, /[iI]/, /[nN]/, /[sS]/, /[uU]/, /[rR]/, /[aA]/, /[nN]/, /[cC]/, /[eE]/],
            postprocess: function (d) {
                return d.join('');
            },
        },
        ...
        {
            name: 'expression',
            symbols: ['percentage', 'expression$ebnf$4', 'expression$ebnf$5'],
            postprocess: (match) => {
                return {
                    amount: match[0],
                    isPercent: true,
        ...
        {
            name: 'dollar$subexpression$2',
            symbols: [/[nN]/, /[oO]/, { literal: ' ' }, /[cC]/, /[hH]/, /[aA]/, /[rR]/, /[gG]/, /[eE]/],
            postprocess: function (d) {
                return d.join('');
            },
        },
        ...
        {
            name: 'percentage$ebnf$1',
            symbols: ['percentage$ebnf$1', 'percentage$ebnf$1$subexpression$2'],
            postprocess: (d) => d[0].concat([d[1]]),
        },
        {
            name: 'percentage$subexpression$1',
            symbols: [{ literal: '%' }],
            postprocess: function (d) {
                return d.join('');
            },
        ...
        {
            name: 'percentage',
            symbols: ['percentage$ebnf$1', 'percentage$subexpression$1'],
            postprocess: (match) => parseFloat(match[0].join('')),
        },
        {
            name: 'percentage$subexpression$2',
            symbols: [/[nN]/, /[oO]/, { literal: ' ' }, /[cC]/, /[hH]/, /[aA]/, /[rR]/, /[gG]/, /[eE]/],
            postprocess: function (d) {
                return d.join('');
            },
        ...
        {
            name: 'frequency$string$1',
            symbols: [{ literal: 'p' }, { literal: 'e' }, { literal: 'r' }, { literal: ' ' }],
            postprocess: (d) => d.join(''),
        },
        {
            name: 'frequency$subexpression$1$subexpression$1',
            symbols: [/[dD]/, /[aA]/, /[yY]/],
            postprocess: function (d) {
                return d.join('');
            },
        ...
        {
            name: 'frequency$subexpression$1$subexpression$2',
            symbols: [/[sS]/, /[tT]/, /[aA]/, /[yY]/],
            postprocess: function (d) {
                return d.join('');
            },
        ...
        {
            name: 'frequency',
            symbols: ['frequency$string$1', 'frequency$subexpression$1'],
            postprocess: (match) => match[1][0].toLowerCase(),
        },
        {
            name: 'deductibles$subexpression$1$subexpression$1',
            symbols: [/[aA]/, /[fF]/, /[tT]/, /[eE]/, /[rR]/],
            postprocess: function (d) {
                return d.join('');
            },
        },
        ...
        {
            name: 'deductibles$subexpression$1$subexpression$2',
            symbols: [/[wW]/, /[iI]/, /[tT]/, /[hH]/],
            postprocess: function (d) {
                return d.join('');
            },
        ...
        {
            name: 'deductibles$subexpression$2',
            symbols: [{ literal: ' ' }, /[dD]/, /[eE]/, /[dD]/, /[uU]/, /[cC]/, /[tT]/, /[iI]/, /[bB]/, /[lL]/, /[eE]/],
            postprocess: function (d) {
                return d.join('');
            },
        },
        {
            name: 'deductibles',
            symbols: ['deductibles$subexpression$1', 'deductibles$subexpression$2'],
            postprocess: (match) => (match[0] === 'after' ? 'after' : 'before'),
        },
    ],
