...
export function createSinglePropertyObject<S extends string, P>(property: S, value?: P): Record<S, P> | {} {
    return value === undefined || (typeof value === 'string' && value === "") ? {} : {[property]: value};
}
