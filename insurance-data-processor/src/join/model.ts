...
import {
    ...
    PlanTypes,
    PlanDemographics,
    DentalPlanMetalLevels,
    NormalPlanMetalLevels,
    BenefitItemLimitUnits,
    BenefitItemLimitFrequencies,
    BenefitItemCostSharingDeductibleStatuses,
    BenefitItemCostSharingFrequencies,
} from '../util';
    ...
    properties: {
        ...
        dmp: {
            ...
            required: [
                ...
                'depression',
                'diabetes',
                'highBloodPressureAndHighCholesterol',
                'lowBackPain',
                'painManagement',
                'pregnancy',
                'weightLoss',
    ...
    definitions: {
        ...
        planAttributes: {
            allOf: [
                ...
                {
                    oneOf: [planAttributesDentalOnlySchema, planAttributesNonDentalOnlySchema],
                },
            ],
        },
        rate: {
