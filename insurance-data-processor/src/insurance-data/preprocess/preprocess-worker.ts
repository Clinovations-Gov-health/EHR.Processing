...
import {
    BenefitItemCostSharingScheme,
    BenefitItemLimit,
    CostSharingBenefit,
    CostSharingPreprocessModel,
    EHBInfo,
    RawCostSharingModel,
} from './interface/cost-sharing';
import {
    DentalOnlyDependentProperties,
    PlanAttributePreprocessModel,
    RawAttributeModel,
    SingleTieredMaximumDeducitbleProperties,
    MultiTieredMaximumDeductibleProperties,
    SingleTieredOOPProperties,
    MultiTieredOOPProperties,
    CostCeilingProperties,
} from './interface/plan-attribute';
...
export const worker = {
    preprocessAttributesData: (chunk: string) => {
        ...
        const TRANSFORMATION_MAP = {
            ...
            ChildOnlyOffering: (val: string): PlanDemographic => {
                switch (val) {
                    case 'Allows Adult and Child-Only':
                        return 'both';
                    case 'Allows Adult-Only':
                        return 'adult';
                    case 'Allows Child-Only':
                        return 'child';
                    default:
        ...
        const result = dataForge
            ...
            .aggregate<{ [key: string]: PlanAttributePreprocessModel }>({}, (prev, row) => {
                const dentalOnlyDependentProperties: DentalOnlyDependentProperties = row.DentalOnlyPlan
                    ...
                    : {
                          ...
                          dmp: {
                              ...
                              highBloodPressureAndHighCholesterol: row.DiseaseManagementProgramsOffered.includes(
                ...
                prev[row.PlanId] = {
                    ...
                    ...createSinglePropertyObject(
                        'beginPrimaryCareCostSharingAfterNumberOfVisits',
                        row.BeginPrimaryCareCostSharingAfterNumberOfVisits
                    ),
                    ...
                    ...createSinglePropertyObject(
                        ...
                        row.BeginPrimaryCareDeductibleCoinsuranceAfterNumberOfCopays
                    ),
        ...
        function getDeductibleProperties(
            row: TransformedData
        ): SingleTieredMaximumDeducitbleProperties | MultiTieredMaximumDeductibleProperties {
            return match<[boolean, boolean], SingleTieredMaximumDeducitbleProperties | MultiTieredMaximumDeductibleProperties>([
                row.MultipleInNetworkTiers,
                row.MedicalDrugDeductiblesIntegrated,
            ])
                .with([false, true], () => ({
                    medicalDrugIntegrated: true,
                    inNetwork: {
                        individual: row.TEHBDedInnTier1Individual,
                        familyPerPerson: row.TEHBDedInnTier1FamilyPerPerson,
                        familyPerGroup: row.TEHBDedInnTier1FamilyPerGroup,
                        coinsurance: row.TEHBDedInnTier1Coinsurance,
                    },
                    outNetwork: {
                        individual: row.TEHBDedOutOfNetIndividual,
                        familyPerPerson: row.TEHBDedOutOfNetFamilyPerPerson,
                        familyPerGroup: row.TEHBDedOutOfNetFamilyPerGroup,
                    },
                    combined: {
                        individual: row.TEHBDedCombInnOonIndividual,
                        familyPerPerson: row.TEHBDedCombInnOonFamilyPerPerson,
                        familyPerGroup: row.TEHBDedCombInnOonFamilyPerGroup,
                    },
                }))
                .with([false, false], () => ({
                    medicalDrugIntegrated: false,
                    medicalInNetwork: {
                        individual: row.MEHBDedInnTier1Individual,
                        familyPerPerson: row.MEHBDedInnTier1FamilyPerPerson,
                        familyPerGroup: row.MEHBDedInnTier1FamilyPerGroup,
                        coinsurance: row.MEHBDedInnTier1Coinsurance,
                    },
                    medicalOutNetwork: {
                        individual: row.MEHBDedOutOfNetIndividual,
                        familyPerPerson: row.MEHBDedOutOfNetFamilyPerPerson,
                        familyPerGroup: row.MEHBDedOutOfNetFamilyPerGroup,
                    },
                    medicalCombined: {
                        individual: row.MEHBDedCombInnOonIndividual,
                        familyPerPerson: row.MEHBDedCombInnOonFamilyPerPerson,
                        familyPerGroup: row.MEHBDedCombInnOonFamilyPerGroup,
                    },
                    drugInNetwork: {
                        individual: row.DEHBDedInnTier1Individual,
                        familyPerPerson: row.DEHBDedInnTier1FamilyPerPerson,
                        familyPerGroup: row.DEHBDedInnTier1FamilyPerGroup,
                        coinsurance: row.DEHBDedInnTier1Coinsurance,
                    },
                    drugOutNetwork: {
                        individual: row.DEHBDedOutOfNetIndividual,
                        familyPerPerson: row.DEHBDedOutOfNetFamilyPerPerson,
                        familyPerGroup: row.DEHBDedOutOfNetFamilyPerGroup,
                    },
                    drugCombined: {
                        individual: row.DEHBDedCombInnOonIndividual,
                        familyPerPerson: row.DEHBDedCombInnOonFamilyPerPerson,
                        familyPerGroup: row.DEHBDedCombInnOonFamilyPerGroup,
                    },
                }))
                .with([true, true], () => ({
                    medicalDrugIntegrated: true,
                    ...
                    tierTwoInNetwork: {
                        individual: row.TEHBDedInnTier2Individual,
                        familyPerPerson: row.TEHBDedInnTier2FamilyPerPerson,
                        familyPerGroup: row.TEHBDedInnTier2FamilyPerGroup,
                        coinsurance: row.TEHBDedInnTier2Coinsurance,
                    },
                    outNetwork: {
                        individual: row.TEHBDedOutOfNetIndividual,
                        familyPerPerson: row.TEHBDedOutOfNetFamilyPerPerson,
                    ...
                    combined: {
                        individual: row.TEHBDedCombInnOonIndividual,
                        familyPerPerson: row.TEHBDedCombInnOonFamilyPerPerson,
                        familyPerGroup: row.TEHBCombInnOonFamilyPerGroupMOOP,
                    },
                }))
                .with([true, false], () => ({
                    medicalDrugIntegrated: false,
                    medicalTierOneInNetwork: {
                        individual: row.MEHBDedInnTier1Individual,
                        familyPerPerson: row.MEHBDedInnTier1FamilyPerPerson,
                        familyPerGroup: row.MEHBDedInnTier1FamilyPerGroup,
                        coinsurance: row.MEHBDedInnTier1Coinsurance,
                    },
                    medicalTierTwoInNetwork: {
                        individual: row.MEHBDedInnTier2Individual,
                        familyPerPerson: row.MEHBDedInnTier2FamilyPerPerson,
                        familyPerGroup: row.MEHBDedInnTier2FamilyPerGroup,
                        coinsurance: row.MEHBDedInnTier2Coinsurance,
                    },
                    medicalOutNetwork: {
                        individual: row.MEHBDedOutOfNetIndividual,
                        familyPerPerson: row.MEHBDedOutOfNetFamilyPerPerson,
                    ...
                    drugTierOneInNetwork: {
                        individual: row.DEHBDedInnTier1Individual,
                        familyPerPerson: row.DEHBDedInnTier1FamilyPerPerson,
                        familyPerGroup: row.DEHBDedInnTier1FamilyPerGroup,
                        coinsurance: row.DEHBDedInnTier1Coinsurance,
                    },
                    drugTierTwoInNetwork: {
                        individual: row.DEHBDedInnTier2Individual,
                        familyPerPerson: row.DEHBDedInnTier2FamilyPerPerson,
                        familyPerGroup: row.DEHBDedInnTier2FamilyPerGroup,
                        coinsurance: row.DEHBDedInnTier2Coinsurance,
                    },
                    drugOutNetwork: {
                        individual: row.DEHBDedOutOfNetIndividual,
                        familyPerPerson: row.DEHBDedOutOfNetFamilyPerPerson,
        ...
        function getOOPProperties(row: TransformedData): SingleTieredOOPProperties | MultiTieredOOPProperties {
            return match<[boolean, boolean], SingleTieredOOPProperties | MultiTieredOOPProperties>([
                row.MultipleInNetworkTiers,
                row.MedicalDrugMaximumOutofPocketIntegrated,
            ])
                .with([false, true], () => ({
                    medicalDrugIntegrated: true,
                    inNetwork: {
                        individual: row.TEHBInnTier1IndividualMOOP,
                        familyPerPerson: row.TEHBInnTier1FamilyPerPersonMOOP,
                        familyPerGroup: row.TEHBInnTier1FamilyPerGroupMOOP,
                    },
                    outNetwork: {
                        individual: row.TEHBOutOfNetIndividualMOOP,
                        familyPerPerson: row.TEHBOutOfNetFamilyPerPersonMOOP,
                        familyPerGroup: row.TEHBOutOfNetFamilyPerGroupMOOP,
                    },
                    combined: {
                        individual: row.TEHBCombInnOonIndividualMOOP,
                        familyPerPerson: row.TEHBCombInnOonFamilyPerPersonMOOP,
                        familyPerGroup: row.TEHBCombInnOonFamilyPerGroupMOOP,
                    },
                }))
                .with([false, false], () => ({
                    medicalDrugIntegrated: false,
                    medicalInNetwork: {
                        individual: row.MEHBInnTier1IndividualMOOP,
                        familyPerPerson: row.MEHBInnTier1FamilyPerPersonMOOP,
                        familyPerGroup: row.MEHBInnTier1FamilyPerGroupMOOP,
                    },
                    medicalOutNetwork: {
                        individual: row.MEHBOutOfNetIndividualMOOP,
                        familyPerPerson: row.MEHBOutOfNetFamilyPerPersonMOOP,
                        familyPerGroup: row.MEHBOutOfNetFamilyPerGroupMOOP,
                    },
                    medicalCombined: {
                        individual: row.MEHBCombInnOonIndividualMOOP,
                        familyPerPerson: row.MEHBCombInnOonFamilyPerPersonMOOP,
                        familyPerGroup: row.MEHBCombInnOonFamilyPerGroupMOOP,
                    },
                    drugInNetwork: {
                        individual: row.DEHBInnTier1IndividualMOOP,
                        familyPerPerson: row.DEHBInnTier1FamilyPerPersonMOOP,
                        familyPerGroup: row.DEHBInnTier1FamilyPerGroupMOOP,
                    },
                    drugOutNetwork: {
                        individual: row.DEHBOutOfNetIndividualMOOP,
                        familyPerPerson: row.DEHBOutOfNetFamilyPerPersonMOOP,
                        familyPerGroup: row.DEHBOutOfNetFamilyPerGroupMOOP,
                    },
                    drugCombined: {
                        individual: row.DEHBCombInnOonIndividualMOOP,
                        familyPerPerson: row.DEHBCombInnOonFamilyPerPersonMOOP,
                        familyPerGroup: row.DEHBCombInnOonFamilyPerGroupMOOP,
                    },
                }))
                .with([true, true], () => ({
                    medicalDrugIntegrated: true,
                    ...
                    tierTwoInNetwork: {
                        individual: row.TEHBInnTier2IndividualMOOP,
                        familyPerPerson: row.TEHBInnTier2FamilyPerPersonMOOP,
                        familyPerGroup: row.TEHBInnTier2FamilyPerGroupMOOP,
                    },
                    outNetwork: {
                        individual: row.TEHBOutOfNetIndividualMOOP,
                        familyPerPerson: row.TEHBOutOfNetFamilyPerPersonMOOP,
                ...
                .with([true, false], () => ({
                    ...
                    medicalTierTwoInNetwork: {
                        individual: row.MEHBInnTier2IndividualMOOP,
                        familyPerPerson: row.MEHBInnTier2FamilyPerPersonMOOP,
                        familyPerGroup: row.MEHBInnTier2FamilyPerGroupMOOP,
                    },
                    medicalOutNetwork: {
                        individual: row.MEHBOutOfNetIndividualMOOP,
                        familyPerPerson: row.MEHBOutOfNetFamilyPerPersonMOOP,
                    ...
                    drugTierTwoInNetwork: {
                        individual: row.DEHBInnTier2IndividualMOOP,
                        familyPerPerson: row.DEHBInnTier2FamilyPerPersonMOOP,
                        familyPerGroup: row.DEHBInnTier2FamilyPerGroupMOOP,
                    },
                    drugOutNetwork: {
                        individual: row.DEHBOutOfNetIndividualMOOP,
                        familyPerPerson: row.DEHBOutOfNetFamilyPerPersonMOOP,
    ...
    preprocessCostSharingData: (chunk: string) => {
        ...
        const result = dataForge
            ...
            .aggregate<Record<string, CostSharingPreprocessModel>>({}, (prev, row) => {
                ...
                const limit: BenefitItemLimit | undefined = row.LimitUnit ? { quantity: row.LimitQty!, ...row.LimitUnit } : undefined;

                const inNetworkTierTwo = compact([row.CopayInnTier2, row.CoinsInnTier2]) as
                    | []
                    | [BenefitItemCostSharingScheme]
                    | [BenefitItemCostSharingScheme, BenefitItemCostSharingScheme];
                ...
                const result: CostSharingBenefit =
                    row.IsCovered && !isEmpty(inNetworkTierOne) && !isEmpty(outOfNetwork)
                        ? {
                              covered: true,
                              ...
                              inNetworkTierOne: inNetworkTierOne as
                                  | [BenefitItemCostSharingScheme]
                                  | [BenefitItemCostSharingScheme, BenefitItemCostSharingScheme],
                              outOfNetwork: outOfNetwork as
                                  | [BenefitItemCostSharingScheme]
                                  | [BenefitItemCostSharingScheme, BenefitItemCostSharingScheme],
                              ...(isEmpty(inNetworkTierTwo)
                                  ? {}
                                  : {
                                        inNetworkTierTwo: inNetworkTierTwo as
                                            | [BenefitItemCostSharingScheme]
                                            | [BenefitItemCostSharingScheme, BenefitItemCostSharingScheme],
                                    }),
    ...
    preprocessRateData: (chunk: string) => {
        ...
        type TransformedData = {
            [Property in keyof RawRateModel]: Property extends keyof typeof TRANSFORMATION_MAP
                ? ReturnType<typeof TRANSFORMATION_MAP[Property]>
                : RawRateModel[Property];
        };
        ...
        return dataForge
            ...
            .aggregate<{ [key: string]: RatePreprocessModel }>({}, (prev, row) => {
                ...
                if (!isFamilyPlan) {
                    ...
                    rateDetail.tobaccoRate[ageIndex] =
                        !row.Tobacco || row.Tobacco === 'No Preference' ? row.IndividualRate : row.IndividualTobaccoRate!;
                }
