...
const CostDefinitionSchema = new Schema({
...
const PlanCostSharingSchema = new Schema({
...
const PremiumScenariosSchema = new Schema({
...
const InsurancePlanSchema = new Schema({
    ...
    "customerServicePhoneNumberLocal": { type: String, required: true },
...
export const InsurancePlanModel = model('InsurancePlan', InsurancePlanSchema, 'InsurancePlan');