    ...
    ParserRules: [
        {
            ...
            symbols: [{ literal: ' ' }, /[pP]/, /[eE]/, /[rR]/, { literal: ' ' }],
        ...
        {
            name: 'expression',
            symbols: ['unit', 'expression$subexpression$1', 'expression$ebnf$1', 'period'],
            postprocess: (match) => ({
                unit: match[0],
        ...
        {
            name: 'unit$subexpression$1$subexpression$1',
            symbols: [/[sS]/],
            postprocess: function (d) {
                return d.join('');
            },
        ...
        {
            name: 'unit$subexpression$1$subexpression$2',
            symbols: [{ literal: '(' }, /[sS]/, { literal: ')' }],
            postprocess: function (d) {
                return d.join('');
            },
        },
